...
public class ShiftOneActivity extends AppCompatActivity {
    ...
    public void loadAdapter() {
        ...
        attendaceAdapter = new Shift1Adapter(ShiftOneActivity.this,attendanceResponseArrayList);
