...
import simplycodighub.masjid_e_ala.Adapter.Shift0Adapter;
...
public class ShiftZeroActivity extends AppCompatActivity {
    LinearLayoutManager linearLayoutManager;
    List<AttendanceListResponse0> attendanceResponseArrayList = new ArrayList<>();
    IRestService service;
    RecyclerView attendanceRecyclerlist;
    Shift0Adapter attendaceAdapter;
    ProgressDialog progressDialog;
    ShimmerFrameLayout mShimmerViewContainer;
    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_shift_zero);
    ...
    public void loadAdapter() {
        ...
        attendaceAdapter = new Shift0Adapter(ShiftZeroActivity.this,attendanceResponseArrayList);
    ...
    private void getList() {
        ...
        service.getAttendanceList0().enqueue(new Callback<List<AttendanceListResponse0>>() {
            @Override
            public void onResponse(Call<List<AttendanceListResponse0>> call, Response<List<AttendanceListResponse0>> response) {
            ...
            @Override
            public void onFailure(Call<List<AttendanceListResponse0>> call, Throwable t) {
