...
public class ShiftFourActivity extends AppCompatActivity {
    LinearLayoutManager linearLayoutManager;
    List<AttendanceListResponse4> attendanceResponseArrayList = new ArrayList<>();
    IRestService service;
    RecyclerView attendanceRecyclerlist;
    Shift4Adapter attendaceAdapter;
    ProgressDialog progressDialog;
    ShimmerFrameLayout mShimmerViewContainer;
    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_shift_four);
    ...
    public void loadAdapter() {
        ...
        attendaceAdapter = new Shift4Adapter(ShiftFourActivity.this,attendanceResponseArrayList);
