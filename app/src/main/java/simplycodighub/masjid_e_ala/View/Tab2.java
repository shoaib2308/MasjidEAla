...
public class Tab2 extends Fragment implements MyAdapter2.CallBack,SwipeRefreshLayout.OnRefreshListener{
    ...
    MyAdapter2 adapter;
    RecyclerView lv;
    ArrayList<AttendanceListResponse2>  xyz =  new ArrayList<>();
    final  Tab2 context = this;
    ...
    private void loadAdapter() {
       ...
       // adapter = new MyAdapter2(xyz,Tab2.this);
