...
import simplycodighub.masjid_e_ala.View.Tab5;

public class MyAdapter5 extends RecyclerView.Adapter<MyAdapter5.MyViewHolder> {

    private List<AttendanceListResponse5> list= new ArrayList<>();
    ...
    private MyAdapter5.CallBack mCallBack;

    private ArrayList<AttendanceListResponse5> categoriesList;

    public MyAdapter5(MyAdapter5.CallBack callback){
        mCallBack = callback;
    }

    public MyAdapter5(List<AttendanceListResponse5> xyz,Tab5 tab5) {
        this.list = xyz;
        this.tab5=tab5;
        this.list2=xyz;
    ...
    public void onBindViewHolder(@NonNull MyViewHolder holder, int position) {
        ...
        final AttendanceListResponse5 attendanceListResponse = list.get(position);
