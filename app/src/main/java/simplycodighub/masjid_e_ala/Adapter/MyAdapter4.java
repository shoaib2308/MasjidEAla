...
import simplycodighub.masjid_e_ala.View.Tab4;

public class MyAdapter4 extends RecyclerView.Adapter<MyAdapter4.MyViewHolder> {

    private List<AttendanceListResponse4> list= new ArrayList<>();

    private List<AttendanceListResponse4> list2= new ArrayList<>();
    ...
    private ArrayList<AttendanceListResponse4> categoriesList;

    public MyAdapter4 (MyAdapter1.CallBack callback){
        mCallBack = callback;
    }

    public MyAdapter4(List<AttendanceListResponse4> xyz,Tab4 tab4) {
        this.list = xyz;
        this.tab4=tab4;
        this.list2=xyz;
    ...
    public void swap(ArrayList<AttendanceListResponse4> datas) {
    ...
    public void onBindViewHolder(@NonNull MyViewHolder holder, int position) {
        ...
        final AttendanceListResponse4 attendanceListResponse = list.get(position);
    ...
    private void getList() {
        ...
        service.getAttendanceList4().enqueue(new Callback<List<AttendanceListResponse4>>() {
            ...
            public void onResponse(Call<List<AttendanceListResponse4>> call, Response<List<AttendanceListResponse4>> response) {
                ...
                categoriesList = new ArrayList<AttendanceListResponse4>();
