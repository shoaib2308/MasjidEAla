...
import simplycodighub.masjid_e_ala.View.Tab3;

public class MyAdapter3 extends RecyclerView.Adapter<MyAdapter3.MyViewHolder> {

    private List<AttendanceListResponse3> list= new ArrayList<>();

    private List<AttendanceListResponse3> list2= new ArrayList<>();
    ...
    private ArrayList<AttendanceListResponse3> categoriesList;

    public MyAdapter3 (MyAdapter1.CallBack callback){
        mCallBack = callback;
    }

    public MyAdapter3(List<AttendanceListResponse3> xyz,Tab3 tab3) {
        this.list = xyz;
        this.tab3=tab3;
        this.list2=xyz;
    ...
    public void swap(ArrayList<AttendanceListResponse3> datas) {
    ...
    public void onBindViewHolder(@NonNull MyViewHolder holder, int position) {
        ...
        final AttendanceListResponse3 attendanceListResponse = list.get(position);
    ...
    private void getList() {
        ...
        service.getAttendanceList3().enqueue(new Callback<List<AttendanceListResponse3>>() {
            ...
            public void onResponse(Call<List<AttendanceListResponse3>> call, Response<List<AttendanceListResponse3>> response) {
                ...
                categoriesList = new ArrayList<AttendanceListResponse3>();
